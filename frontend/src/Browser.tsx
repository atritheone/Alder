...
export default function Browser({
  ...
  const pickCategory = (name: string) => {
    ...
    setFilter("All");
    setSearch("");
    if (["Voices", "Styles", "Templates"].includes(name))
      onPanel(name.toLowerCase());
  };
  return (
      ...
      <div className="browser-main">
        ...
        <div className="browser-results">
          <div className="filter-header">
            <ChevronDown size={13} /> Filters <SlidersHorizontal size={13} />
          </div>
              ...
              project.clips
                ...
                .map((c) => (
                  <button
                    ...
                    draggable
                    onDragStart={(e) =>
                      e.dataTransfer.setData("application/x-alder-clip", c.id)
                    }
              ...
              deviceCatalog
                ...
                .map((d) => (
                  <button
                    ...
                    draggable
                    onDragStart={(e) =>
                      e.dataTransfer.setData("application/x-alder-device", d.id)
                    }
            ...
            {["Ideas", "Words", "Favourites"].includes(category) &&
              !visible.length && (
                <p className="empty-small">
                  No matching samples. Try another filter or add your own idea.
                </p>
              )}
          </div>
        </div>
          ...
          <>
            <div>
              ...
              <button
                ...
                className={favourites.includes(selected.id) ? "favourited" : ""}
